...
AppConnectCordova.prototype.ACPasteboardPolicy = {
    ...
    AUTHORIZED:  1,   // The application may write data to the pasteboard which gets shared
                      // among all apps (Both AppConnect and non-AppConnect apps can read this data).
    SECURECOPY:  2    // The application may write data to the general pasteboard which is shared
                      ...
                      //
                      // If the app is not authorized, or if the device user has not entered the AppConnect
                      // passcode when required, writing to the general pasteboard will fail and reading from
